...
<small><sub>Version: 10.10.0 </sub></small>
				...
				<h1>
					<a href="solace.html" ><abbr title="solace">solace</abbr></a>.ClientCapabilityType
				</h1>
			</div>
		</header>
	...
	<ul>
		...
		<li><a href="#static_properties">Static Properties & Enumerations</a></li>
			...
			<div class="description "><p><p>Represents an enumeration of client capabilities.
These are sent in the ClientCtrl login messages.</p></p></div>
  ...
  <tbody>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#BR_ERRORID">
        	<abbr title="solace.ClientCapabilityType.BR_ERRORID">
        		BR_ERRORID
        	</abbr>
        </a>
    ...
    <tr class="public">
      ...
      <td class="last">
        <a href="#UNBIND_ACK">
        	<abbr title="solace.ClientCapabilityType.UNBIND_ACK">
        		UNBIND_ACK
        	</abbr>
        </a>
      ...
      <td>
			...
			<h3 id="BR_ERRORID" class="public">
  
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_workspace_solclientjs_release_npm_org_solclientjs_sdk_core2_modules_solclient-session_lib_capability-types_js.html#lineno158">capability-types.js</a> at line 158
-->
  </div>
...
<div class="description "><p><p>Indicates whether a client will process an EndpointErrorId in a BindResponse message.
Always true</p></p></div>
...
<h3 id="UNBIND_ACK" class="public">
  
  <div class="location">
<!--
  	<a href="_opt_cvsdirs_loadbuild_jenkins_slave_workspace_solclientjs_release_npm_org_solclientjs_sdk_core2_modules_solclient-session_lib_capability-types_js.html#lineno153">capability-types.js</a> at line 153
-->
  </div>
...
<div class="description "><p><p>Client implements acknowledgements to router unsolicited unbinds.
Always true.</p></p></div>
